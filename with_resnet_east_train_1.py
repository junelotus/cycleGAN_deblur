...
score_label = glob.glob('dataset/score_map/*jpg')
# angle_label = glob.glob('./angle_map/*jpg')
geo_label_0 = glob.glob('dataset/geo_map/*_0.jpg')
geo_label_1 = glob.glob('dataset/geo_map/*_1.jpg')
geo_label_2 = glob.glob('dataset/geo_map/*_2.jpg')
geo_label_3 = glob.glob('dataset/geo_map/*_3.jpg')
geo_label_4 = glob.glob('dataset/geo_map/*_4.jpg')
geo_label_5 = glob.glob('dataset/geo_map/*_5.jpg')
geo_label_6 = glob.glob('dataset/geo_map/*_6.jpg')
geo_label_7 = glob.glob('dataset/geo_map/*_7.jpg')
...
train_data_zip = tf.data.Dataset.zip((train_data,label_score_data,label_geo_data)).shuffle(20)#label_angle_data
# In[16]:
